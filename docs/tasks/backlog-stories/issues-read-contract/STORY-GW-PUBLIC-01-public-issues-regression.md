...
## Meta
- **Key:** `STORY-GW-PUBLIC-01-public-issues-regression`
- **Пакет:** [`issues-read-contract/`](./INDEX.md)
- **Status:** 🔵 Done (Awaiting Commits) — pkg-000048 gate PASS 2026-07-10; `test_gw_public_01_public_issues_regression.py` (commit `811ca73`). Header-sync [audit-mvp-scope-hard-2026-07-21](../../../analysis/audit-mvp-scope-hard-2026-07-21.md) §3.
- **Приоритет:** P2 gate
...
- Legacy `POST /intake/stories` ([`:501`](../../../../src/core/api/asgi_app.py)) — к удалению [GW-DRAFT-06](../story-draft-handoff/STORY-GW-DRAFT-06-remove-legacy-intake-stories-route.md); contrast-тесты на **story-drafts**, не intake.
...
- [ ] T01–T02: read routes публичны
- [ ] T03–T04: write routes закрыты без service auth
- [ ] Тесты в offline-сюите (без сети), зелёные
