...
- **Type:** docs / ops (migration SSOT)
- **Status:** 🔵 Done (Awaiting Commits) — gate PASS 2026-08-07T09:59:37Z pkg-000058
- **Приоритет:** ⚪ LOW — hygiene SSOT; Public Node уже text (DRAFT-07)
- **source:** [`../../../../backlog-stories/taxonomy-fidelity/STORY-GW-TAX-03-align-story-labels-migration-text-fk.md`](../../../../backlog-stories/taxonomy-fidelity/STORY-GW-TAX-03-align-story-labels-migration-text-fk.md)
...
- **Зависит от:** [GW-TAX-01](../STORY-GW-TAX-01-taxonomy-persistence-fidelity/STORY-GW-TAX-01-taxonomy-persistence-fidelity.md) Done; [GW-DRAFT-07](../../../../backlog-stories/story-draft-handoff/STORY-GW-DRAFT-07-hosted-schema-blocks-browser-submit.md) Done (hosted DDL already text)
- **Разблокирует:** безопасный fresh-host apply из `supabase/migrations/` без UUID/text drift
- **Не reopen:** GW-DRAFT-07
- **Operative queue:** [`../../../../gateway-active-packages/pkg-000058-20260807-gw-tax-03-align-story-labels-migration-text-fk.yaml`](../../../../gateway-active-packages/pkg-000058-20260807-gw-tax-03-align-story-labels-migration-text-fk.yaml) via [`../../../../gateway-active-package.current.yaml`](../../../../gateway-active-package.current.yaml) — **5** тасков T01–T05
- **decision_ref:** backlog TAX-03 + elegance + execution G1
- **P1 decision (T02 path):** edit in-place `20260714_1200_gw_tax_01_story_labels.sql` (not additive successor)
...
| Источник | `story_labels.story_id` | Ref |
|----------|-------------------------|-----|
| Repo migration TAX-01 (pre-T02) | **UUID** FK | pre-edit `20260714_…story_labels.sql` (было UUID DDL) |
...
|-------|-------------|------|
| 1 | [`task-gw-tax-03-t01-inventory-dual-path`](./task-gw-tax-03-t01-inventory-dual-path/README.md) | pkg-000058 |
| 2 | [`task-gw-tax-03-t02-align-migration-text-fk`](./task-gw-tax-03-t02-align-migration-text-fk/README.md) | pkg-000058 |
| 3 | [`task-gw-tax-03-t03-rls-grant-parity-bootstrap`](./task-gw-tax-03-t03-rls-grant-parity-bootstrap/README.md) | pkg-000058 |
| 4 | [`task-gw-tax-03-t04-docs-index-elegance-note`](./task-gw-tax-03-t04-docs-index-elegance-note/README.md) | pkg-000058 |
| 5 | [`task-gw-tax-03-t05-story-acceptance-gate`](./task-gw-tax-03-t05-story-acceptance-gate/README.md) | pkg-000058 |
| 6 | [`task-gw-tax-03-t06-audit-r1-story-present-tense`](./task-gw-tax-03-t06-audit-r1-story-present-tense/README.md) | `run_mode=gw_tax_03_audit_followup` |
| 7 | [`task-gw-tax-03-t07-audit-r2-satellite-ssot-grant-note`](./task-gw-tax-03-t07-audit-r2-satellite-ssot-grant-note/README.md) | `run_mode=gw_tax_03_audit_followup` |
| 8 | [`task-gw-tax-03-t08-audit-g3-migration-text-assert`](./task-gw-tax-03-t08-audit-g3-migration-text-assert/README.md) | `run_mode=gw_tax_03_audit_followup` |
