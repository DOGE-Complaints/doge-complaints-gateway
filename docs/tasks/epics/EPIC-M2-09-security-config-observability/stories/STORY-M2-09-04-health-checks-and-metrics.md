...
## AC / DoD
- [x] Договорённый контракт `/health` / `/ready` (или эквивалент в текущем ASGI).
- [x] Базовые метрики (например запросы, ошибки) — in-process или текстовый endpoint.
- [x] Тесты на доступность health.
