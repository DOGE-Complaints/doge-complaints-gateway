## Task workspace — `task-m2-09-05-t07-gap-trace-08-per-story-file-log`
...
### Scope
GAP-TRACE-08: per-story file debug logs via LOG_DEBUG_DIR.

## Task: implement — task-m2-09-05-t07-gap-trace-08-per-story-file-log
