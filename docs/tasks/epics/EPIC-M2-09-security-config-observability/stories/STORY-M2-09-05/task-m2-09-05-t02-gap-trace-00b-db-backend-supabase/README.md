## Task workspace — `task-m2-09-05-t02-gap-trace-00b-db-backend-supabase`
...
### Scope
GAP-TRACE-00B: DB_BACKEND=supabase env evidence and guardrails.

## Task: ops — task-m2-09-05-t02-gap-trace-00b-db-backend-supabase
