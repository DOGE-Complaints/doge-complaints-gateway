## Task workspace — `task-m2-09-05-t01-gap-trace-00-loglevel-apply`
...
### Scope
GAP-TRACE-00: apply LOG_LEVEL to Python logging subsystem.

## Task: implement — task-m2-09-05-t01-gap-trace-00-loglevel-apply
