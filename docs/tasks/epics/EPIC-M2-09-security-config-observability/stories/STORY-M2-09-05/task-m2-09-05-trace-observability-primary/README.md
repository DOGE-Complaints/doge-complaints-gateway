## Task workspace — `task-m2-09-05-trace-observability-primary`
...
### Scope
story-level orchestration and acceptance gates for GAP-TRACE wave.

## Task: orchestrate — task-m2-09-05-trace-observability-primary
