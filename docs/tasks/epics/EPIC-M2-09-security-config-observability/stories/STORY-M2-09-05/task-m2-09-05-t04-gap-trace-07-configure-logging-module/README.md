## Task workspace — `task-m2-09-05-t04-gap-trace-07-configure-logging-module`
...
### Scope
GAP-TRACE-07: introduce configure_logging() module.

## Task: implement — task-m2-09-05-t04-gap-trace-07-configure-logging-module
