...
## AC / DoD
- [x] Контракт «сервисной» аутентификации согласован с `requirements/19` (ссылка в коде/доке).
- [x] Middleware или dependency guard для защищённых маршрутов.
- [x] Тесты: отказ без креденшелов / успех с валидным токеном (stub).
