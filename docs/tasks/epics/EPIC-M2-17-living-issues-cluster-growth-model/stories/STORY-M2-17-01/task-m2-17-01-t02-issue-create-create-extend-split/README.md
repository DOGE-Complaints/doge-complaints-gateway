## Task workspace — `task-m2-17-01-t02-issue-create-create-extend-split`
...
### Scope
Разделение create_issue на create/extend path и idempotent обработка без новых stories.

## Task: implement — T02 delivery
