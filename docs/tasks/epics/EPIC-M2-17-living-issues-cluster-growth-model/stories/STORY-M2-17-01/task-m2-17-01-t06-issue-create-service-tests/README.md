## Task workspace — `task-m2-17-01-t06-issue-create-service-tests`
...
### Scope
Unit тесты сервиса create/extend в новом test_issue_create_service.py.

## Task: implement — T06 delivery
