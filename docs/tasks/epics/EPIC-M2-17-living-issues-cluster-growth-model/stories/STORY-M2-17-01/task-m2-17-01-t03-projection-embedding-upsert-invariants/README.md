## Task workspace — `task-m2-17-01-t03-projection-embedding-upsert-invariants`
...
### Scope
Проверка/фиксация upsert поведения projection и embeddings в SQLite/Supabase.

## Task: implement — T03 delivery
