## Task workspace — `task-m2-17-01-t05-candidate-lookup-update-backend-parity`
...
### Scope
Паритет find_promoted/save update-path для InMemory/SQLite/Supabase.

## Task: implement — T05 delivery
