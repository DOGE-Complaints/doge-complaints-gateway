## Task workspace — `task-m2-17-01-t01-promotion-extend-primitive`
...
### Scope
Реализация extend_candidate в promotion сервисе + дедуп story_ids и audit event.

## Task: implement — T01 delivery
